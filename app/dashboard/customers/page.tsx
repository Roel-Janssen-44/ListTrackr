      ...
      <div className="w-full overflow-x-auto rounded-lg bg-white scrollbar dark:bg-secondary">
        <div className="text-left text-sm font-normal">
          <div className="flex animate-pulse flex-row">
            <div className="mb-3 h-6 w-full flex-1 rounded-md bg-gray-300 px-3 py-3 pb-2 font-medium dark:bg-gray-700 md:w-[250px] lg:w-[350px]" />
            <div className="mb-3 h-6 w-full flex-1 rounded-md bg-gray-300 px-3 py-3 pb-2 font-medium dark:bg-gray-700 md:w-[250px] lg:w-[350px]" />
          </div>
        </div>
        <div className="relative block max-h-[600px] w-full max-w-full overflow-y-auto">
          {[...Array(5)].map((_, index) => (
            <div
              key={index}
            ...
            >
              <div className="group flex w-full flex-row flex-nowrap items-center text-sm">
                <div className="h-6 w-1/2 rounded-md bg-gray-300 px-3 py-4 dark:bg-gray-700 md:w-[250px] lg:w-[350px]" />
                <div className="h-6 w-1/2 rounded-md bg-gray-300 px-3 py-4 dark:bg-gray-700 md:w-[250px] lg:w-[350px]" />
              </div>
            </div>
          ))}
