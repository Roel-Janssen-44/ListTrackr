...
export default async function SideNav() {
  return (
    <div className="z-30 flex h-full flex-col bg-gray-100 p-4 transition-all md:fixed md:left-0 md:top-0 md:h-screen md:min-h-screen md:max-w-[64px] md:p-2 group-hover:md:w-full group-hover:md:max-w-[256px] group-hover:md:shadow-sm">
